...
{
    public abstract class TemplateOperationsBase<T> : SafeDNSOperations where T : Template
    {
        public TemplateOperationsBase(IUKFastSafeDNSClient client) : base(client) { }
